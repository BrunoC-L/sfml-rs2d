...
class AbstractPlayer : public AbstractService {
	virtual std::pair<std::string, std::string> getCredentials(std::string tempsalt, std::string permsalt) const = 0;
public:
	...
	virtual void login(std::string tempsalt, std::string permsalt) = 0;
