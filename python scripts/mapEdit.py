...
class CanvasImage:
    ...
    def __init__(self, placeholder, path):
        ...
        self.canvas.bind('<ButtonRelease-2>', self.__offset)  # move canvas to the new position
        self.canvas.bind('<MouseWheel>',      self.__wheel)  # zoom for Windows and MacOS, but not Linux
        self.canvas.bind('<Button-5>',        self.__wheel)  # zoom for Linux, wheel scroll down
        self.canvas.bind('<Button-4>',        self.__wheel)  # zoom for Linux, wheel scroll up
        self.canvas.bind('<Button-1>',        self.__left)
        self.canvas.bind('<Button-3>',        self.__right)
...
path = 'C:/Users/Bruno/Desktop/prog/src/c++/sfml-rs2d/assets/map - Copy.jpg'  # place path to your image here
